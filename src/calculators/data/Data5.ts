export const rarePersonae = ['Regent', 'Queen\'s Necklace', 'Stone of Scone', 'Koh-i-Noor', 'Orlov', 'Emperor\'s Amulet', 'Hope Diamond', 'Crystal Skull'];
...
export const dlcPersona = [['Orpheus', 'Orpheus Picaro'], ['Izanagi', 'Izanagi Picaro'], ['Thanatos', 'Thanatos Picaro'],
