import type { SkillMap } from './SkillData';
...
export const skillMapRoyal: SkillMap = {
  ...
  'Brave Blade': {
    ...
    talk: 'Infuriated Wisdom King (Atavaka)',
  },
  'Brave Step': {
    cost: 1600,
  ...
  'Concentrate': {
    ...
    talk: 'Decadent False God (Alilat)',
  },
  'Confuse Boost': {
  ...
  'Fire Amp': {
    ...
    talk: 'Deformed Lion God (Chimera)',
  },
  'Fire Boost': {
  ...
  'Gigantomachia': {
    ...
    talk: 'Evil Voracious Dragon (Fafnir)',
  },
  'Gloomy Child': {
  ...
  'Heat Riser': {
    ...
    talk: 'Evil Synthetic Organism (Byakhee)',
  },
  'Heat Up': {
    card: 'Trial 50',
  ...
  'Matarukaja': {
    ...
    talk: 'Lamenting Sacrifice (Kushinada)',
  },
  'Matarunda': {
    card: 'Jazz 8/7 11/6',
    cost: 2400,
  ...
  'Mazionga': {
    ...
    talk: 'Storm-Invoking Ptarmigan (Thunderbird)',
  },
  'Me Patra': {
    cost: 800,
  ...
  'One-shot Kill': {
    ...
    talk: 'Spear-Wielding General (Cu Chulainn)',
  },
  'Oni Kagura': {
    cost: 16,
